...
#define STARTER_TURTWIG     0
#define STARTER_CHIMCHAR    1
#define STARTER_PIPLUP      2
...
// 4: After getting a Pokémon and going home
// 5: After getting the Running Shoes
// 6: Usual state- Mom heals your Pokémon
...
#define VAR_BARRY_FOLLOW_INTERACTIONS                    0x40DB // Number of times talked to Barry on Route 201/Lake Verity
...
#define VAR_ROUTE_221_HOUSE_LEVEL                        0x40F7 // level requested by the man on route 221
#define VAR_ROUTE_221_HOUSE_ITEM                         0x40F8 // 0: black belt, 1:expert belt, 2:focus sash
