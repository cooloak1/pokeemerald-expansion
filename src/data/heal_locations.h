static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TWINLEAF_TOWN - 1] = {MAP_GROUP(TWINLEAF_TOWN), MAP_NUM(TWINLEAF_TOWN), 14, 18},
    [HEAL_LOCATION_SANDGEM_TOWN - 1] = {MAP_GROUP(SANDGEM_TOWN), MAP_NUM(SANDGEM_TOWN), 15, 6},
    [HEAL_LOCATION_JUBILIFE_CITY - 1] = {MAP_GROUP(JUBILIFE_CITY), MAP_NUM(JUBILIFE_CITY), 44, 37},
    [HEAL_LOCATION_CANALAVE_CITY - 1] = {MAP_GROUP(CANALAVE_CITY), MAP_NUM(CANALAVE_CITY), 22, 11},
    [HEAL_LOCATION_FLOAROMA_TOWN - 1] = {MAP_GROUP(FLOAROMA_TOWN), MAP_NUM(FLOAROMA_TOWN), 13, 53},
    [HEAL_LOCATION_OREBURGH_CITY - 1] = {MAP_GROUP(OREBURGH_CITY), MAP_NUM(OREBURGH_CITY), 15, 50},
    [HEAL_LOCATION_ETERNA_CITY - 1] = {MAP_GROUP(ETERNA_CITY), MAP_NUM(ETERNA_CITY), 15, 19},
    [HEAL_LOCATION_SOLACEON_TOWN - 1] = {MAP_GROUP(SOLACEON_TOWN), MAP_NUM(SOLACEON_TOWN), 10, 10},
    [HEAL_LOCATION_HEARTHOME_CITY - 1] = {MAP_GROUP(HEARTHOME_CITY), MAP_NUM(HEARTHOME_CITY), 8, 10},
    [HEAL_LOCATION_CELESTIC_TOWN - 1] = {MAP_GROUP(CELESTIC_TOWN), MAP_NUM(CELESTIC_TOWN), 21, 22},
    [HEAL_LOCATION_VEILSTONE_CITY - 1] = {MAP_GROUP(VEILSTONE_CITY), MAP_NUM(VEILSTONE_CITY), 10, 10},
    [HEAL_LOCATION_PASTORIA_CITY - 1] = {MAP_GROUP(PASTORIA_CITY), MAP_NUM(PASTORIA_CITY), 10, 10},
    [HEAL_LOCATION_SUNYSHORE_CITY - 1] = {MAP_GROUP(SUNYSHORE_CITY), MAP_NUM(SUNYSHORE_CITY), 10, 10},
    [HEAL_LOCATION_SNOWPOINT_CITY - 1] = {MAP_GROUP(SNOWPOINT_CITY), MAP_NUM(SNOWPOINT_CITY), 10, 10},
    [HEAL_LOCATION_VALOR_LAKEFRONT - 1] = {MAP_GROUP(VALOR_LAKEFRONT), MAP_NUM(VALOR_LAKEFRONT), 23, 31},
};
