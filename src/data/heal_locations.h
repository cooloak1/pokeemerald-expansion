static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TWINLEAF_TOWN - 1] = {MAP_GROUP(TWINLEAF_TOWN), MAP_NUM(TWINLEAF_TOWN), 14, 20},
    [HEAL_LOCATION_SANDGEM_TOWN - 1] = {MAP_GROUP(SANDGEM_TOWN), MAP_NUM(SANDGEM_TOWN), 15, 6},
    [HEAL_LOCATION_JUBILIFE_CITY - 1] = {MAP_GROUP(JUBILIFE_CITY), MAP_NUM(JUBILIFE_CITY), 43, 36},
    [HEAL_LOCATION_CANALAVE_CITY - 1] = {MAP_GROUP(CANALAVE_CITY), MAP_NUM(CANALAVE_CITY), 14, 10},
};
