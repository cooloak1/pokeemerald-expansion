static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CANALAVE_CITY - 1] = {MAP_GROUP(CANALAVE_CITY), MAP_NUM(CANALAVE_CITY), 24, 11},
    [HEAL_LOCATION_FLOAROMA_TOWN - 1] = {MAP_GROUP(FLOAROMA_TOWN), MAP_NUM(FLOAROMA_TOWN), 13, 53},
    [HEAL_LOCATION_OREBURGH_CITY - 1] = {MAP_GROUP(OREBURGH_CITY), MAP_NUM(OREBURGH_CITY), 44, 18},
    [HEAL_LOCATION_ETERNA_CITY - 1] = {MAP_GROUP(ETERNA_CITY), MAP_NUM(ETERNA_CITY), 15, 19},
    [HEAL_LOCATION_SOLACEON_TOWN - 1] = {MAP_GROUP(SOLACEON_TOWN), MAP_NUM(SOLACEON_TOWN), 20, 15},
    ...
    [HEAL_LOCATION_PASTORIA_CITY - 1] = {MAP_GROUP(PASTORIA_CITY), MAP_NUM(PASTORIA_CITY), 11, 17},
