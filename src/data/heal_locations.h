static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_JUBILIFE_CITY - 1] = {MAP_GROUP(JUBILIFE_CITY), MAP_NUM(JUBILIFE_CITY), 42, 36},
    [HEAL_LOCATION_CANALAVE_CITY - 1] = {MAP_GROUP(CANALAVE_CITY), MAP_NUM(CANALAVE_CITY), 22, 11},
    [HEAL_LOCATION_FLOAROMA_TOWN - 1] = {MAP_GROUP(FLOAROMA_TOWN), MAP_NUM(FLOAROMA_TOWN), 13, 10},
    [HEAL_LOCATION_OREBURGH_CITY - 1] = {MAP_GROUP(OREBURGH_CITY), MAP_NUM(OREBURGH_CITY), 15, 50},
    [HEAL_LOCATION_ETERNA_CITY - 1] = {MAP_GROUP(ETERNA_CITY), MAP_NUM(ETERNA_CITY), 14, 14},
