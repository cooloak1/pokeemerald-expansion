static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TWINLEAF_TOWN - 1] = {MAP_GROUP(TWINLEAF_TOWN), MAP_NUM(TWINLEAF_TOWN), 10, 10},
    [HEAL_LOCATION_SANDGEM_TOWN - 1] = {MAP_GROUP(SANDGEM_TOWN), MAP_NUM(SANDGEM_TOWN), 14, 15},
};
