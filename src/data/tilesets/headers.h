...
const struct Tileset gTileset_SinnohWest =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_SinnohWest,
...
const struct Tileset gTileset_Floaroma =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Floaroma,
    .palettes = gTilesetPalettes_Floaroma,
    .metatiles = gMetatiles_Floaroma,
...
const struct Tileset gTileset_GenericHouse =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_GenericHouse,
    .palettes = gTilesetPalettes_GenericHouse,
    .metatiles = gMetatiles_GenericHouse,
...
const struct Tileset gTileset_BarrysRoom =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_BarrysRoom,
    .palettes = gTilesetPalettes_BarrysRoom,
    .metatiles = gMetatiles_BarrysRoom,
    .metatileAttributes = gMetatileAttributes_BarrysRoom,
    .callback = NULL,
};

const struct Tileset gTileset_RivalsRoom =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_RivalsRoom,
    .palettes = gTilesetPalettes_RivalsRoom,
    .metatiles = gMetatiles_RivalsRoom,
    .metatileAttributes = gMetatileAttributes_RivalsRoom,
    .callback = NULL,
};

const struct Tileset gTileset_Sunyshore =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Sunyshore,
    .palettes = gTilesetPalettes_Sunyshore,
    .metatiles = gMetatiles_Sunyshore,
...
const struct Tileset gTileset_Condo =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Condo,
    .palettes = gTilesetPalettes_Condo,
    .metatiles = gMetatiles_Condo,
    .metatileAttributes = gMetatileAttributes_Condo,
    .callback = NULL,
};

const struct Tileset gTileset_House1 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_House1,
    .palettes = gTilesetPalettes_House1,
    .metatiles = gMetatiles_House1,
...
const struct Tileset gTileset_SinnohEast =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_SinnohEast,
