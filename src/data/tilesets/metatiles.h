...
const u16 gMetatiles_SinnohWest[] = INCBIN_U16("data/tilesets/primary/sinnoh_west/metatiles.bin");
const u16 gMetatileAttributes_SinnohWest[] = INCBIN_U16("data/tilesets/primary/sinnoh_west/metatile_attributes.bin");
