...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_TWINLEAF_TOWN] = {MAP_GROUP(TWINLEAF_TOWN), MAP_NUM(TWINLEAF_TOWN), HEAL_LOCATION_TWINLEAF_TOWN},
    [MAPSEC_SANDGEM_TOWN] = {MAP_GROUP(SANDGEM_TOWN), MAP_NUM(SANDGEM_TOWN), HEAL_LOCATION_SANDGEM_TOWN},
    [MAPSEC_JUBILIFE_CITY] = {MAP_GROUP(JUBILIFE_CITY), MAP_NUM(JUBILIFE_CITY), HEAL_LOCATION_JUBILIFE_CITY},
