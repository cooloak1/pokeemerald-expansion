...
{
    {MAPSEC_HOENN,               MAPSEC_LILYCOVE_CITY},
...
{
    [ABNORMAL_WEATHER_ROUTE_114_NORTH - 1] = MAPSEC_HOENN
};
...
{
    [MAPSEC_HOENN] = {MAP_GROUP(MAP_LITTLEROOT_TOWN), MAP_NUM(MAP_LITTLEROOT_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
    ...
    //[MAPSEC_ONE_ISLAND] = {MAP_GROUP(MAP_ONE_ISLAND_KINDLE_ROAD), MAP_NUM(MAP_ONE_ISLAND_KINDLE_ROAD), HEAL_LOCATION_NONE},
...
static void InitMapBasedOnPlayerLocation(void)
{
    ...
    case MAP_TYPE_OCEAN_ROUTE:
        ...
        if (sRegionMap->mapSecId == MAPSEC_HOENN)
