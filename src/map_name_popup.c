...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_MYSTERY_ZONE] = MAPPOPUP_THEME_WOOD,
    ...
    //[MAPSEC_HOENN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_MYSTERY_ZONE] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    //[MAPSEC_HOENN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
};
...
{
    if (mapHeader->regionMapSectionId != MAPSEC_KANTO)
        return FALSE;
